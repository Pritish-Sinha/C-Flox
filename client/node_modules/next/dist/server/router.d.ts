...
export declare type Route = {
    ...
    internal?: true;
    fn: (req: BaseNextRequest, res: BaseNextResponse, params: Params, parsedUrl: NextUrlWithParsedQuery, upgradeHead?: any) => Promise<RouteResult> | RouteResult;
};
...
export default class Router {
    ...
    execute(req: BaseNextRequest, res: BaseNextResponse, parsedUrl: NextUrlWithParsedQuery, upgradeHead?: any): Promise<boolean>;
}
export {};
